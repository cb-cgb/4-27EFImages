$(() => {
    ...
    function RefreshTable() {
        ...
        $.get('/home/GetImages', images => {
            images.forEach(img => {
                $('tbody').append(
                    `<tr>
                       <td>
                          <a href="${img.imageUrl}" target="_blank"><h6>${img.title} </h6></a>
                       ...
                       <td>
                         <button data-imageid="${img.id}" data-countlikes=${img.countLikes} class="btn btn-success like">Like!
    ...
    $("#add-image").on('click', function () {
     ...
     $('tbody').on('click','.like', function () {
        ...
        const img = {
         ...
         $.post('/home/UpdateLikes', img, function (obj) {
